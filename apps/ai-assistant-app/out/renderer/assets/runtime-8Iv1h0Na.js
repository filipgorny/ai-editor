import { _ as __vitePreload, c as commonjsGlobal, a as clearBoundCombos, b as commander, d as appBus, n as normCombo, e as bindCombo } from "./index-DtNksEyl.js";
...
const glueWasmUrl = "" + new URL("glue-Dlydm7r2.wasm", import.meta.url).href;
let enginePromise = null;
const unsubscribers = [];
async function getEngine() {
  if (!enginePromise) {
    enginePromise = (async () => {
      const factory = new distExports.LuaFactory(glueWasmUrl);
...
function installBridge(lua) {
  ...
  g.set("log", (...args) => console.info("[lua]", ...args));
