...
export default {
  ...
  settings: {
    ...
    themeAutogenDark: '🧬 Autogenerated dark — synthesized from name & package',
    themeAutogenLight: '🧬 Autogenerated light — synthesized from name & package',
  ...
  editor: {
    ...
    clearTabs: 'Clear',
    clearTabsTitle: 'Close all open windows'
  },
  graph: {
